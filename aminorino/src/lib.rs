...
//!
//! AMINORINO is a comprehensive framework for bridging biological neural consciousness
...
//!
//! ```rust
//! use aminorino::hodgkin_huxley::HodgkinHuxleyNeuron;
//!
...
//!
//! ```rust
//! use aminorino::iit::{IITSystem, ApproximationMethod};
//!
...
//!
//! ```rust,no_run
//! use aminorino::neural_dynamics::{NetworkBuilder, ConnectionPattern, SynapseType};
//!
...
//!
//! ```rust,no_run
//! use aminorino::tda::{PersistentHomology, SpikeTrain};
//!
